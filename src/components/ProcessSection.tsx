...
export default function ProcessSection() {
  ...
  return (
    <section className="py-28 bg-charcoal" ref={sectionRef}>
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-16">
          ...
          <p data-reveal className="font-sans text-sm leading-relaxed text-cream-muted font-light lg:self-end">
        ...
        <div data-reveal className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
          {steps.map((step, i) => (
