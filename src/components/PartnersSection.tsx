        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div data-reveal>
            ...
            <p className="font-sans text-sm md:text-base leading-[1.8] text-cream-muted font-light max-w-md mb-6">
              Since {COMPANY_STATS.foundingYear}, Patrick and Tim have built a trusted network of contractors, architects, and service providers who understand how owner-operators work.
            </p>
          ...
          <div data-reveal className="hidden lg:grid grid-cols-2 gap-4">
            ...
            <div className="bg-charcoal-mid border border-border/40 p-8 text-center">
              <div className="font-display text-4xl font-semibold text-gold mb-2 tracking-tight">{COMPANY_STATS.yearsInOperation}</div>
              <div className="font-sans text-[10px] tracking-[0.2em] uppercase text-cream-muted/60">Years Since {COMPANY_STATS.foundingYear}</div>
            </div>
            <div className="bg-charcoal-mid border border-border/40 p-8 text-center">
